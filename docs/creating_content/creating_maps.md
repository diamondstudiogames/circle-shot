...
5. Скорее всего в `map_<выбранное событие>.tscn` были расположены дополнительные узлы - точки появления игроков, флагов, т.д. Не забудьте их передвинуть под нужды Вашей карты.
