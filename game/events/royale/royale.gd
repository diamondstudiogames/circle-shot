...
## Базовый интервал появления коробок с оружием.
@export var weapon_box_spawn_interval_base := 50.0
## Увеличение интервала появления коробок с оружием за каждого живого игрока.
...
## Базовое количество монет, которое получит игрок за первое место.
