...
@onready var _weapon: Node2D = $Visual/Weapon/Scythe
@onready var _weapon_anim: AnimationPlayer = $Visual/Weapon/Scythe/AnimationPlayer
@onready var _attack: Attack = $Visual/Weapon/Scythe/Attack
