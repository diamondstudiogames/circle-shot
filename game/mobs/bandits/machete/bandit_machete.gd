...
@onready var _weapon: Node2D = $Visual/Weapon/Machete
@onready var _weapon_anim: AnimationPlayer = $Visual/Weapon/Machete/AnimationPlayer
@onready var _attack: Attack = $Visual/Weapon/Machete/Attack
