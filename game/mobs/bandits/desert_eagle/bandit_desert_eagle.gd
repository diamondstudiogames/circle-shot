...
@onready var _weapon: Node2D = $Visual/Weapon/DesertEagle
@onready var _weapon_parent: Node2D = $Visual/Weapon
@onready var _shoot_point: Marker2D = $Visual/Weapon/DesertEagle/ShootPoint
@onready var _weapon_anim: AnimationPlayer = $Visual/Weapon/DesertEagle/AnimationPlayer
