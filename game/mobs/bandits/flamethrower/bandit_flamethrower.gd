...
@onready var _weapon: Node2D = $Visual/Weapon/Flamethrower
@onready var _weapon_parent: Node2D = $Visual/Weapon
@onready var _shoot_point: Marker2D = $Visual/Weapon/Flamethrower/ShootPoint
@onready var _weapon_anim: AnimationPlayer = $Visual/Weapon/Flamethrower/AnimationPlayer
